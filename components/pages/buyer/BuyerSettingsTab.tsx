...
import BuyerBusinessInfo from "@/components/forms/BuyerBusinessInfo";
import BuyerVerificationDoc from "@/components/forms/BuyerVerificationDoc";
...
const BuyerSettingsTab = ({ user }: Props) => {
  return (
    <div className="max-w-[54rem] rounded-lg bg-light-900 px-3 py-6 md:px-6 md:py-14">
      <Tabs defaultValue="profile" className="">
        ...
        <TabsContent value="profile" className="w-full space-y-6">
          <div className="">
            <BuyerBusinessInfo user={user} />
            <BuyerVerificationDoc user={user} />
          </div>
        </TabsContent>
