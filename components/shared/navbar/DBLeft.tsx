...
const DBLeft = ({ user }: Props) => {
  ...
  return (
    <div className="custom-scrollbar sticky left-0 top-0 z-[950] flex h-screen shrink-0 flex-col overflow-y-auto bg-light-900 pb-4 max-lg:px-1 max-lg:shadow-sm max-md:hidden lg:w-[14rem] xl:w-[15rem]">
