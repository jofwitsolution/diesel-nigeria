...
const Page = () => {
  return (
    <>
      <div className="pt-[2.1rem] md:pt-[3.25rem]">
        <div className="max-width">
          <section className="padding-bottom">
            <h1 className="mx-auto max-w-[50.8125rem] text-center font-fraunces text-[1.5rem] font-normal leading-[2.2rem] md:text-[3rem] md:leading-[3.5rem]">
              Finding An Efficient Diesel Solution For Nigerian Businesses Is
              Our Ultimate Goal!
            </h1>
            <p className="mx-auto mt-[1.25rem] max-w-[55.9375rem] text-center font-medium text-[#505050] md:mt-[2.5rem] md:text-[1.25rem] md:leading-[1.99rem]">
              ...
              of timely and accurate information for businesses, given the
              highly volatile diesel pricing, and we update our info with a
              time-gap of 2 hours daily.
            </p>
            ...
            <div className="flex w-full flex-col items-center gap-8 md:flex-row">
              <div>
                ...
                <p className="max-w-[32.75rem] font-medium md:leading-[1.75rem]">
                  ...
                  channels, guaranteeing that the data you receive is
                  trustworthy and reflective of the current market conditions
                </p>
              </div>
              <div>
                <Image
                  ...
                  height={442}
                  alt="filling"
                  className="rounded-[0.9rem] border-[3px] border-black xs:rounded-[1.2rem]"
                />
              </div>
            </div>
            <div className="mt-[2.5rem] flex w-full flex-col-reverse items-center gap-8 md:mt-[5rem] md:flex-row">
              <div className="rounded-[0.9rem] border-[3px] border-black xs:rounded-[1.2rem]">
                <Image
              ...
              <div>
                ...
                <p className="max-w-[32.75rem] font-medium md:leading-[1.75rem]">
                  We have deployed a fleet of delivery vehicles manned by
                  trained drivers aided by tech navigational and tracking tools,
                  to ensure last-mile retail deliveries to the customer
                  locations.
                </p>
              </div>
            </div>
        ...
        <section className="padding-top padding-bottom">
          <div className="mx-auto flex max-w-[92.8125rem] flex-wrap gap-[2rem] px-[1.2rem]">
            <div className="md:max-w-[33.4375rem]">
            ...
            <div className="md:max-w-[28.25rem]">
              <h3 className="mb-[0.8rem] font-fraunces text-[1.35rem] md:text-[1.5rem]">
        ...
        <section className="padding-top padding-bottom">
          ...
          <div className="flex flex-wrap justify-center gap-[1.5rem]">
            <div className="numbers-card">
              <span className="numbers-card-number">750</span>
              <span className="">Avg. daily site visitors</span>
            </div>
            <div className="numbers-card">
              <span className="numbers-card-number">5</span>
              <span className="">AGO supply partners</span>
            </div>
            <div className="numbers-card">
              <span className="numbers-card-number">25</span>
