    ...
    <div className="max-width pt-[2.1rem] md:pt-[3.25rem]">
      <section className="padding-bottom">
        ...
        <p className="mx-auto mt-[1.25rem] max-w-[55.9375rem] text-center font-medium text-[#505050] md:mt-[2.5rem] md:text-[1.25rem] md:leading-[1.99rem]">
          ...
          diesel (AGO) depot prices in Nigeria. We understand the importance of
          timely and accurate information for businesses, given the highly
        ...
        <div className="flex flex-wrap gap-[2.5rem]">
          <div className="md:max-w-[27.4375rem]">
            ...
            <p className="font-medium md:leading-[1.75rem]">
              ...
              with a select group of trusted suppliers on our platform, ensuring
              quick delivery and reducing the need for extensive storage as well
              as exposure to unethical/ inefficient transactions
            </p>
          </div>
          <div className="md:max-w-[24.25rem]">
            ...
            <p className="font-medium md:leading-[1.75rem]">
              Prompted by the need to bring efficiency to diesel transactions in
              Nigeria, our team comprises industry experts dedicated to
              revolutionizing the way you buy diesel. We understand the value of
              speed, transparency, and reliability in your operations, and we’ve
              built our platform with these principles at its core
            </p>
          </div>
          <div className="md:max-w-[24.25rem]">
            <h3 className="mb-[0.8rem] font-fraunces text-[1.35rem] md:text-[1.5rem]">
